...
export default class Login extends Component {
  ...
  handleOnSubmit(e) {
    ...
    .catch (
      err => this.setState(
        this.setMessage(
          `Usuario o Password incorrectos: ${err.message}`
        )
      )
    )
  }
  ...
  resetPassword () {
    resetPassword( this.email.value )
      .then ( () => this.setState ( this.setMessage (`Se ha enviado un correo electrónico a <b>${this.email.value}</b> para restablecer tu contraseña`)))
      .cath ( err => this.setState( this.setMessage (`El email ${this.email.value} no se encuentra registrado`)))
  }
